...
## What is it?
OpenClaw is Julia's **communication layer** — the component responsible for everything related to messaging apps. It connects Julia to the outside world: Telegram, WhatsApp, Slack, and Discord. All inbound messages from users arrive through OpenClaw. All outbound replies go out through OpenClaw.
...
- Check its own health (`openclaw health`)
