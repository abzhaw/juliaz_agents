      ...
      <header className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-4">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold tracking-tight">Julia</h1>
          </div>
          <p className="text-muted-foreground text-sm">Multi-agent command & control interface v2.0</p>
        </div>

        <div className="flex items-center gap-4">
          <Link to="/architecture" className="flex items-center gap-2 bg-white/5 hover:bg-white/10 border border-white/5 px-4 py-2 rounded-2xl transition-all">
