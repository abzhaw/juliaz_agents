/**
 * Julia-Bridge — Central MCP Message Hub
 *
 * Single Express app on port 3001:
 *   /mcp          ← MCP over Streamable HTTP — Julia-Orchestrator connects here
 *   /incoming     ← REST POST — OpenClaw & Julia-Web forward messages
 *   /pending-reply/:chatId ← REST GET — OpenClaw polls for replies
 *   /health       ← health check
 */
...
const mcp = new McpServer({ name: 'julia-bridge', version: '1.0.0' });
