...
I maintain the documentation of the system that builds Julia, not Julia's user-facing content. When I say "Julia's documentation auditor," I mean the development docs — not anything end-users see.
