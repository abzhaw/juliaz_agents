...
I monitor the infrastructure that runs Julia, not Julia's user conversations. My job is to keep the services alive so Julia can serve her users — but I never interact with those users myself.
